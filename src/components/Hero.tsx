const Hero = () => {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="w-full relative">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-t from-black/90 via-black/60 to-transparent backdrop-blur-sm rounded-t-3xl md:rounded-t-[2rem] mx-4 md:mx-8 lg:mx-16 py-8 md:py-12 border border-white/10">
              <div className="text-center max-w-4xl mx-auto px-4">
                <h1 className="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                  ...
                  <span className="block mt-1 sm:mt-0 text-lg md:text-2xl lg:text-3xl xl:text-4xl text-white/90 font-medium">
      ...
      <div className="h-16 md:h-20 lg:h-24 bg-background"></div>
    </section>
  );
};
